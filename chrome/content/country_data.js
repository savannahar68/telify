...
["", "", "", ""],
["+1", "USA, Canada", "us,mil,gov,edu,ca", "1"],
...
var telify_flag_exception = [
["+1", "204", "1-ca"], // Manitoba
["+1", "226", "1-ca"], // Ontario (London, Windsor)
["+1", "250", "1-ca"], // British Columbia
["+1", "289", "1-ca"], // Ontario (Hamilton)
["+1", "306", "1-ca"], // Saskatchewan
["+1", "343", "1-ca"], // Ontario (Ottawa)
["+1", "403", "1-ca"], // Alberta
["+1", "416", "1-ca"], // Ontario (Toronto)
["+1", "418", "1-ca"], // Quebec
["+1", "438", "1-ca"], // Quebec (Montreal)
["+1", "450", "1-ca"], // Quebec
["+1", "506", "1-ca"], // New Brunswick
["+1", "514", "1-ca"], // Quebec (Montreal)
["+1", "519", "1-ca"], // Ontario (London, Windsor)
["+1", "579", "1-ca"], // Quebec
["+1", "581", "1-ca"], // Quebec
["+1", "587", "1-ca"], // Alberta
["+1", "600", "1-ca"], // Special purpose
["+1", "604", "1-ca"], // British Columbia
["+1", "613", "1-ca"], // Ontario (Ottawa)
["+1", "647", "1-ca"], // Ontario (Toronto)
["+1", "705", "1-ca"], // Ontario (North Bay)
["+1", "709", "1-ca"], // Newfoundland
["+1", "778", "1-ca"], // British Columbia
["+1", "780", "1-ca"], // Alberta
["+1", "807", "1-ca"], // Ontario (Thunder Bay)
["+1", "819", "1-ca"], // Quebec (Sherbrooke)
["+1", "867", "1-ca"], // Yukon, NW Terr., Nunavut
["+1", "902", "1-ca"], // Nova Scotia, Prince Edward Island
["+1", "905", "1-ca"], // Ontario (Hamilton)
];
